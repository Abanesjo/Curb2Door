...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.button_build_source.sizePolicy().hasHeightForWidth())
        self.button_build_source.setSizePolicy(sizePolicy4)
        ...
        self.radio_custom_msg = QRadioButton(self.groupBox)
        self.radio_custom_msg.setObjectName(u"radio_custom_msg")
        sizePolicy5.setHeightForWidth(self.radio_custom_msg.sizePolicy().hasHeightForWidth())
        self.radio_custom_msg.setSizePolicy(sizePolicy5)
        self.radio_custom_msg.setChecked(True)

        self.verticalLayout_4.addWidget(self.radio_custom_msg)

        self.radio_pointcloud = QRadioButton(self.groupBox)
        self.radio_pointcloud.setObjectName(u"radio_pointcloud")
        sizePolicy5.setHeightForWidth(self.radio_pointcloud.sizePolicy().hasHeightForWidth())
        self.radio_pointcloud.setSizePolicy(sizePolicy5)
        self.radio_pointcloud.setAutoFillBackground(False)

        self.verticalLayout_4.addWidget(self.radio_pointcloud)
        ...
        sizePolicy4.setHeightForWidth(self.line_bag_path.sizePolicy().hasHeightForWidth())
        self.line_bag_path.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.line_bag_name.sizePolicy().hasHeightForWidth())
        self.line_bag_name.setSizePolicy(sizePolicy4)
        ...
        self.gridLayout_2.addWidget(self.button_begin_recording, 3, 0, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.button_end_recording, 3, 1, 2, 1)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.text_lidar_freq, 1, 2, 1, 2)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.text_imu_freq, 1, 4, 1, 2)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.text_image_freq, 1, 0, 1, 2)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"PointCloud Format", None))
        self.radio_custom_msg.setText(QCoreApplication.translate("MainWindow", u"Livox Custom Msg", None))
        self.radio_pointcloud.setText(QCoreApplication.translate("MainWindow", u"PointCloud2", None))
        self.line_bag_path.setText(QCoreApplication.translate("MainWindow", u"/mnt/internal/bag/compressed", None))
