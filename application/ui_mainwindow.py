...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.radio_custom_msg.sizePolicy().hasHeightForWidth())
        self.radio_custom_msg.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.radio_pointcloud.sizePolicy().hasHeightForWidth())
        self.radio_pointcloud.setSizePolicy(sizePolicy4)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.line_bag_path.setText(QCoreApplication.translate("MainWindow", u"/mnt/internal/bag", None))
