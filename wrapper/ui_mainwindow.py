...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_record_true.setText(QCoreApplication.translate("MainWindow", u"Livox Custom Msg", None))
        self.radio_record__false.setText(QCoreApplication.translate("MainWindow", u"PointCloud2", None))
